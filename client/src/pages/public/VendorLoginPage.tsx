...
import { Printer, ArrowRight, ArrowLeft, Store, Lock, Mail } from 'lucide-react';
      ...
      <div className="mt-8 w-full max-w-md mx-auto">
        <div className="bg-white border border-slate-200 py-8 px-6 sm:px-8 rounded-xl shadow-xs">
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="vendor@campusprint.com"
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-1.5" htmlFor="vendor-password">
                Password
              </label>
              <div className="relative">
                <input
